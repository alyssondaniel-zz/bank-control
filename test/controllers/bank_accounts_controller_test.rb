...
class BankAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post bank_accounts_url, params: { bank_account: { bank_agency_id: @bank_account.bank_agency_id, limit: @bank_account.limit, number: @bank_account.number } }
    end
  ...
  test "should update bank_account" do
    patch bank_account_url(@bank_account), params: { bank_account: { bank_agency_id: @bank_account.bank_agency_id, limit: @bank_account.limit, number: @bank_account.number } }
